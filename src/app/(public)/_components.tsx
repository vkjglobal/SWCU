...
export function InnerHero({ eyebrow, title, summary }: { eyebrow: string; title: string; summary?: string }) {
  return <section className="route-placeholder"><div className="site-container"><p className="eyebrow">{eyebrow}</p><h1>{title}</h1>{summary && <p className="max-w-2xl text-lg text-charcoal/75">{summary}</p>}</div></section>;
}
