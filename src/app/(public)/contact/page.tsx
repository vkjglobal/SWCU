...
export async function generateMetadata(): Promise<Metadata> { return buildPublicMetadata((await headers()).get("host") ?? "", "/contact", "Contact SWCU | Service Worker Credit Union", "Contact Service Worker Credit Union by phone, email or through the website."); }
