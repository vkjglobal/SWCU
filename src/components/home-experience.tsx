...
export interface MemberAppSettings { enabled: boolean; label: string; }
...
export function HomeExperience({ heroSlides = [], highlights = [], services = [], forms = [], news = [], faqs = [], contact, memberApp = { enabled: true, label: "Member App — Coming Soon" } }: HomeExperienceProps) {
  const reduce = useReducedMotion();
