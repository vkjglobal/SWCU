...
async function main() {
  ...
  const actor = `prompt3b-http-admin-${suffix}`; const createdMedia: string[] = []; const objectKeys: string[] = []; const createdDocs: string[] = []; const createdRefs: string[] = []; const createdLeadership: string[] = []; let child: ReturnType<typeof spawn> | undefined;
